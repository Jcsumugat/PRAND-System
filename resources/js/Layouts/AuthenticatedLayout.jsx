...
export default function AuthenticatedLayout({ children }) {
    ...
    const getCurrentRoute = () => {
        ...
        if (componentPath.includes('deceased') && componentPath.includes('create')) return 'deceased.create';
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center lg:ml-0 ml-14">
                                <h2 className="text-2xl font-bold text-gray-900">
                                    {getCurrentRoute().split('.')[0].charAt(0).toUpperCase() +
                                     getCurrentRoute().split('.')[0].slice(1)}
                                </h2>
                            </div>
