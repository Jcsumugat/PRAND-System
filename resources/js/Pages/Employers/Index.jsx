...
import { UserIcon, PencilIcon, TrashIcon, PlusIcon, XMarkIcon, PhoneIcon, EnvelopeIcon, LockClosedIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
...
export default function Index({ employers = [] }) {
    ...
    const handlePasswordVerification = async () => {
        ...
        try {
            ...
            const response = await fetch(`/employers/${selectedEmployer.id}/verify-password`, {
                method: 'POST',
                headers: {
            ...
            if (passwordAction === 'delete') {
                router.delete(`/employers/${selectedEmployer.id}`, {
                    data: { password: verificationPassword },
                    onSuccess: () => {
                    ...
                    onError: (errors) => {
                        setPasswordError(errors.password || 'Failed to delete employer');
                        setVerifying(false);
                    }
                });
    ...
    const filteredEmployers = employers.filter(employer =>
        ...
        (employer.mobile_number && employer.mobile_number.includes(searchTerm))
    );
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4 flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-white">Add New Employer</h2>
                                    <p className="text-purple-100 text-sm">Create a new employer account</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="bg-gradient-to-r from-amber-500 to-orange-600 px-6 py-4 rounded-t-xl">
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-amber-100 text-sm">Password required to continue</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                                <p className="text-sm text-amber-800 flex items-start">
                                    ...
                                    <span>
                                        You are about to <strong>{passwordAction}</strong> the account of <strong>{selectedEmployer.name}</strong>. 
                                        Please enter their account password to confirm.
                                    </span>
                                </p>
                            </div>
                            ...
                            <div className="flex gap-3 mt-6">
                                ...
                                <button
                                    ...
                                    disabled={verifying || !verificationPassword}
                                ...
                                >
                                    {verifying ? 'Verifying...' : passwordAction === 'delete' ? 'Delete Account' : 'Continue to Edit'}
                                </button>
                            </div>
                        </div>
                    </div>
