                                    ...
                                    <>
                                        <div className="md:col-span-2 bg-green-50 border-2 border-green-200 rounded-lg p-4">
                                            <div className="flex items-center justify-between mb-3">
                                                <h4 className="text-sm font-semibold text-green-800 uppercase">
                                                    Selected Record
                                                </h4>
                                                <button
                                                    type="button"
                        ...
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    {remainingBalance > 0 && (
                                        <p className="mt-1 text-xs text-orange-600 font-semibold">
                                            {selectedRecord?.amount_paid === 0
                                                ? `Min Down Payment: ₱2,500.00 (50%) | Max: ₱${remainingBalance.toLocaleString(
                                                      "en-US",
                                                      {
                                                          minimumFractionDigits: 2,
                                                      }
                                                  )}`
                                                : `Min: ₱0.01 | Max: ₱${remainingBalance.toLocaleString(
                                                      "en-US",
                                                      {
                                                          minimumFractionDigits: 2,
                                                      }
                                ...
                                <div>
                                    ...
                                    <InputError
                                        message={errors.payment_for}
                                        className="mt-2"
                                    />
                                    {data.payment_for === "renewal" && (
                                        <p className="mt-1 text-xs text-green-600 font-semibold">
                                            This will extend coverage for 5
                                            more years from the last coverage date.
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-gray-600">
                                        All payments must be made in person at
                                ...
                                <div>
                                    <InputLabel
                                        htmlFor="official_receipt_number"
                                        value="Official Receipt Number (Optional)"
                                        className="text-gray-700 font-semibold"
                                    />
                                    <TextInput
                                    ...
                                    />
                                    <InputError
                                        message={errors.official_receipt_number}
                                        className="mt-2"
                                    />
                                </div>
                                <div className="md:col-span-2">
